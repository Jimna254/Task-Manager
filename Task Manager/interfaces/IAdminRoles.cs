...
namespace Task_Manager.interfaces
{
    public interface IAdminRoles
    {
        ...
        public Task<ResponseService> CreateTask(Tasks tasks);

        public Task<ResponseService> UpdateTask(Tasks tasks);

        public Task<ResponseService> DeleteTask(Tasks tasks);
